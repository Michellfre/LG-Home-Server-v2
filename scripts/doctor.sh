...
echo "Open Home Server v10.6 - Diagnóstico"
...
echo "FFmpeg:"; command -v ffmpeg >/dev/null && ffmpeg -version | head -1 || echo "Instale: pkg install ffmpeg"
...
echo "Últimas linhas da API:"; tail -40 ~/Servidor/Logs/api.log 2>/dev/null
