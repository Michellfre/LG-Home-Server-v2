...
BASE="$HOME/Servidor"; WEB="$BASE/Web"; mkdir -p "$WEB" "$BASE/Cameras" "$BASE/Backups" "$BASE/Logs" "$BASE/Files" "$BASE/Trash" "$BASE/Config" "$BASE/Media" "$BASE/Downloads" "$BASE/Documents"
